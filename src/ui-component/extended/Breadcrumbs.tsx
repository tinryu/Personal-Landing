...
interface Propps {
    ...
    navigation: any,
    rightAlign: boolean,
    separator: React.ReactNode | any,
    title: boolean,
    titleBottom: boolean
};
const Breadcrumbs: React.FC<Propps> = ({ card, divider, icon, icons, maxItems, navigation, rightAlign, separator, title, titleBottom, ...others }) => {
